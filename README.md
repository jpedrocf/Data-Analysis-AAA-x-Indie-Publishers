...
The disparity becomes even more monstrous when we compare only the top five highest-revenue games from each type of publisher. Wukong, a standout AAA title, single-handedly surpasses the total revenue generated by all Indie games combined, showcasing just how formidable the financial muscle of AAA studios is. This widening gap emphasizes the blockbuster nature of AAA releases, where a single title can generate earnings that dwarf the entire Indie spectrum. This extreme revenue difference becomes even more evident when visualized. In the next chart, you'll see how the Indie "monster" appears much smaller compared to the sheer scale of AAA revenue, especially when focusing on just the top five games from each category. The difference is staggering, with the AAA giant towering over its Indie counterpart, reflecting the vast financial gulf between them.
...
![Revenue - all data](https://github.com/user-attachments/assets/ed56b810-1573-4e5a-8904-3e1ab933fd10)

The disparity becomes even more monstrous when we compare only the top five highest-revenue games from each type of publisher. Wukong, a standout AAA title, single-handedly surpasses the total revenue generated by all Indie games combined, showcasing just how formidable the financial muscle of AAA studios is. This widening gap emphasizes the blockbuster nature of AAA releases, where a single title can generate earnings that dwarf the entire Indie spectrum. This extreme revenue difference becomes even more evident when visualized. In the next chart, you'll see how the Indie "monster" appears much smaller compared to the sheer scale of AAA revenue, especially when focusing on just the top five games from each category. The difference is staggering, with the AAA giant towering over its Indie counterpart, reflecting the vast financial gulf between them.


![Revenue - top 5](https://github.com/user-attachments/assets/9393a01d-8896-43b0-8764-65e7995dd9d5)
